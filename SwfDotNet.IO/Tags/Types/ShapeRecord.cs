...
namespace SwfDotNet.IO.Tags.Types
{
	...
	public class StyleChangeRecord: NonEdgeRecord
	{
        ...
        public PointF Point0
        {
            get
            {
                float x = (float)this.moveDeltaX / 20;
                float y = (float)this.moveDeltaY / 20;
	...
	public class StraightEdgeRecord: EdgeRecord
	{
        ...
        public PointF Point0
        {
            get
            {
                float x = (float)this.deltaX / 20;
                float y = (float)this.deltaY / 20;
                return new PointF(x, y);
            }
        }
	...
	public class CurvedEdgeRecord: EdgeRecord
	{
        ...
        public PointF Point0
        {
            get
            {
                float x = (float)this.controlDeltaX / 20;
                float y = (float)this.controlDeltaY / 20;
                return new PointF(x, y);
            }
        }
        ...
        public PointF Point1
        {
            get
            {
                float x = (float)this.anchorDeltaX / 20;
                float y = (float)this.anchorDeltaY / 20;
                return new PointF(x, y);
            }
        }
