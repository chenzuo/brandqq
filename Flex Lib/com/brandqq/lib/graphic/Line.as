package com.brandqq.lib.graphic
{
	 ...
	 * 字段		类型		描述				备注
		...
		Points	Array	Segment包含的点	If Type=0 or 1, Point[1]
										...
										If Type=3, Point[4]
	 */
	public final class Line implements ISegment
	{
		/**
		 * 构造函数
		 * @param p
		...
		{
			return "{Type=1,x="+__point.x+",y="+__point.y+"}";
		}
		...
		{
			g.lineTo(this.__point.x+offsetX,this.__point.y+offsetY);
		}
