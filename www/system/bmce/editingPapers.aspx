...
<script runat="server">
    ...
    void Page_Load(object sender, EventArgs e)
    {
        ...
        foreach (Paper obj in Paper.List(papersn,papertitle,PaperStatus.Editing,pager))
        {
            html.AppendLine("<tr id=\"PAPER_" + obj.SN.ToString() + "\">");
            html.AppendLine("<td>" + obj.SN.ToString() + "</td>");
            html.AppendLine("<td><a href=\"publishPaper.aspx?sn=" + obj.SN.ToString() + "\">" + obj.Title + "</a></td>");
            html.AppendLine("<td>" + obj.CreatedDate.ToString() + "</td>");
            html.AppendLine("<td>");
            html.AppendLine("<a href=\"javascript:deleteEditingPaperFile('" + obj.SN.ToString() + "');\">删除</a> ");
            html.AppendLine("<a href=\"previewPaper.aspx?sn=" + obj.SN.ToString() + "\">预览</a> ");
            html.AppendLine("<a href=\"publishPaper.aspx?sn=" + obj.SN.ToString() + "\">继续编辑</a>");
            html.AppendLine("</td>");
            html.AppendLine("</tr>");
        }
    }
