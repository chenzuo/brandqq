...
<script runat="server">
    ...
    string answertitle="";
    Pager pager = new Pager(1, 20, PagerHttpMethod.POST, "SpecimensListForm");
    void Page_Load(object sender, EventArgs e)
    {
        ...
        foreach (SimpleResultStatusRecord sta in Result.StatusList(ResultStatus.Stored, pager))
        {
            html.AppendLine("<tr>");
            html.AppendLine("<td>");
