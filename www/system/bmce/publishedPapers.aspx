...
<script runat="server">
    ...
    void Page_Load(object sender, EventArgs e)
    {
        ...
        foreach (Paper obj in Paper.List(papersn,papertitle,PaperStatus.Published,pager))
        {
            html.AppendLine("<tr>");
            html.AppendLine("<td>" + obj.SN.ToString() + "</td>");
            html.AppendLine("<td><a href=\"publishedPaper.aspx?sn=" + obj.SN.ToString() + "\">" + obj.Title + "</a></td>");
            html.AppendLine("<td>" + obj.CreatedDate.ToShortDateString() + "</td>");
            html.AppendLine("<td><a href=\"publishedPaper.aspx?sn=" + obj.SN.ToString() + "\">详细</a> <a href=\"publishPaper.aspx?sn=" + obj.SN.ToString() + "\">重新编辑</a></td>");
            html.AppendLine("</tr>");
        }
    }
</script>
